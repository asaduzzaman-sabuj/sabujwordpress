...
*/
 jQuery(document).ready(function($) {
    $('#Creativ Kindergarten-img-container li label img').click(function(){    	
        $('#Creativ Kindergarten-img-container li').each(function(){
            $(this).find('img').removeClass ('Creativ Kindergarten-radio-img-selected') ;
        });
        $(this).addClass ('Creativ Kindergarten-radio-img-selected') ;
    });                    
});
