...
$wp_customize->add_section( 'section_home_blog',
	array(
		'title'      => __( 'Blog Section', 'creativ-kindergarten' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[disable_blog_section]', 
	array(		
	'label' 	=> __('Disable Blog Section', 'creativ-kindergarten'),
...
$wp_customize->add_control(
	new creativ_kindergarten_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[blog_category]',
		array(
		'label'    => __( 'Select Category', 'creativ-kindergarten' ),
		'section'  => 'section_home_blog',
...
$wp_customize->add_control( 'theme_options[blog_number]',
	array(
		'label'       => __( 'Number of Posts', 'creativ-kindergarten' ),
		'description' => __('Maximum number of post to show is 6.', 'creativ-kindergarten'),
		'section'     => 'section_home_blog',
		'active_callback' => 'creativ_kindergarten_blog_active',		
		'type'        => 'number',
		'priority'    => 100,
