...
$wplc_tblname_triggers      = $wpdb->prefix . "wplc_chat_triggers";
...
function wplc_uninstall() {
	...
	if ( $wplc_settings->wplc_delete_db_on_uninstall ) {
		...
		$wpdb->query( "DROP TABLE IF EXISTS {$wplc_webhooks_table}" );
		$wpdb->query( "DROP TABLE IF EXISTS {$wplc_custom_fields_table}" );
		$wpdb->query( "DROP TABLE IF EXISTS {$wplc_tblname_chat_departments}" );
		$wpdb->query( "DROP TABLE IF EXISTS {$wplc_tblname_actions_queue}" );
		$wpdb->query( "DROP TABLE IF EXISTS {$wplc_tblname_triggers}" );
		$wpdb->query( "DROP TABLE IF EXISTS {$wplc_quick_responses_table}" );
